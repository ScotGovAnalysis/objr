# Contributing to objr

This outlines how to propose a change to objr. 
...
If you want to make a bigger change, it's a good idea to first [file an issue](https://github.com/ScotGovAnalysis/objr/issues/new) and make sure the package maintainers agree that it’s needed. 
...
* If you work in Scottish Government, request write access to the repository by contacting the [package maintainers](https://ScotGovAnalysis.github.io/objr/authors.html#authors). If you are external, fork the repository.
