...
interface](https://secure.objectiveconnect.co.uk/login)). If the user
required to make these changes is not an R user, they can use the API
via it’s [interactive
...
1.  Navigate to the summary page for your workgroup in Objective
    ...
    Two-step verification’, and click the blue ‘Update’ button. (This
    setting will be reinstated later.)
