...
data.frame(
  asset_name = c("file1", "file2"),
  asset_ext  = c("docx", "csv"),
...
Alternatively, you can read a data file directly into your R environment:
...
data.frame(
  asset_name = c("file1", "file2", "file3"),
  asset_ext  = c("docx", "csv", "csv"),
...
```{r assets3-output, eval = TRUE, echo = FALSE}
data.frame(
  asset_name = c("file1", "file2", "file3", "mtcars"),
  asset_ext  = c("docx", "csv", "csv", "rds"),
  asset_uuid = sapply(3:6, objr:::random_uuid)
)
```
