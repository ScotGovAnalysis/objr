structure(list(method = "PUT", url = "https://api/workgroups/test_workgroup/bypassTwoStepAllowed",
    status_code = 204L, headers = structure(list(Date = "Tue, 12 Mar 2024 12:51:28 GMT",
        Connection = "keep-alive", `X-CONNECT-MDC` = "apioiPMMkyo",
