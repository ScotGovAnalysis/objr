...
structure(list(method = "GET", url = "https://api/assets?workspaceUuid=test_workspace&type=",
    ...
    body = charToRaw("{\"content\":[{\"model\":\"Asset\",\"uuid\":\"test_asset_uuid\",\"name\":\"test_asset_name\",\"type\":\"DOCUMENT\",\"extension\":\"txt\",\"parent\":{\"uuid\":\"test_parent_uuid\",\"name\":\"test_parent_name\"},\"workspace\":{\"uuid\":\"test_workspace_uuid\",\"name\":\"test_workspace_name\"},\"modifiedBy\":{\"givenName\":\"test_modified_name1\",\"familyName\":\"test_modified_name2\"}}],\"metadata\":{\"totalElements\":4,\"totalPages\":1,\"page\":0,\"offset\":0}}"),
